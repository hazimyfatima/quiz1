...
the head will be on c4 because of git checkout experiment.
 Master will be on c4.
 experiment will be on c4.
...
No because it's a new file and not modified.
